...
This guide is for people who want to use more than one Codex account in Neokod.
...
- both accounts can see the same Neokod/Codex sessions
...
In Neokod Settings, name it something obvious:
...
In Neokod Settings, add another Codex provider:
...
Neokod shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, Neokod treats it
