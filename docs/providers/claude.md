...
This guide is for people who want to use more than one Claude setup in Neokod.
...
In Neokod Settings, your Claude provider can stay like this:
...
Add or edit a Claude provider in Neokod Settings:
...
Neokod does not need a special Claude Code Router provider. Treat the router as a Claude
environment.
...
2. Add or configure a Claude provider in Neokod.
