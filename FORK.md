...
| `packages/contracts/src/server.ts`                                                                                                                            | One appended schema block: `CopilotManagedClientEvidenceTestConnectionResult` (`ok`/`status`/`message`; never the credential). Plus device-login schemas `CopilotDeviceLoginStartResult`/`CopilotDeviceLoginStatus(Result)`/`CopilotSignOutResult`/`CopilotDeviceLoginError` (code/URI/status only; never the token).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Typed result contract for the governance test-connection RPC.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
