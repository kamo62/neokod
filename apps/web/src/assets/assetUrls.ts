...
import { resolveAssetUrl } from "@neokod/client-runtime/state/assets";
import type { AssetResource, EnvironmentId } from "@neokod/contracts";
...
export { resolveAssetUrl } from "@neokod/client-runtime/state/assets";
