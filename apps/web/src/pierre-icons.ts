...
const PIERRE_ICON_SPRITE_ID = "neokod-pierre-file-icon-sprite";

const NEOKOD_FILE_ICON_SPRITE = `
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" aria-hidden="true">
  <symbol id="neokod-file-icon-package-json" viewBox="0 0 32 32">
    <path d="M2 2H30V30H2" fill="#c12127" />
    <path d="M7.25 7.25h17.5v17.5h-3.5v-14H16v14H7.25" fill="#fff" />
  </symbol>
  <symbol id="neokod-file-icon-tsconfig" viewBox="0 0 32 32">
  ...
  <symbol id="neokod-file-icon-agents" viewBox="0 0 32 32">
  ...
  <symbol id="neokod-file-icon-claude" viewBox="0 0 32 32">
  ...
  <symbol id="neokod-file-icon-readme" viewBox="0 0 32 32">
  ...
  <symbol id="neokod-file-icon-pnpm" viewBox="0 0 32 32">
...
export const NEOKOD_PIERRE_ICONS = {
  set: "complete",
  colored: true,
  spriteSheet: NEOKOD_FILE_ICON_SPRITE,
  byFileName: {
    "package.json": "neokod-file-icon-package-json",
    "tsconfig.json": "neokod-file-icon-tsconfig",
    "agents.md": "neokod-file-icon-agents",
    "claude.md": "neokod-file-icon-claude",
    "readme.md": "neokod-file-icon-readme",
    "pnpm-lock.yaml": "neokod-file-icon-pnpm",
    "pnpm-workspace.yaml": "neokod-file-icon-pnpm",
  },
} satisfies FileTreeIcons;

const completeIconResolver = createFileTreeIconResolver(NEOKOD_PIERRE_ICONS);
...
export function ensurePierreIconSprite(): void {
  ...
  container.innerHTML = `${getBuiltInSpriteSheet("complete")}${NEOKOD_FILE_ICON_SPRITE}`;
