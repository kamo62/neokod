import type { ServerProvider, ServerProviderVersionAdvisory } from "@neokod/contracts";
...
export function getProviderSummary(
  ...
  if (!provider.enabled) {
    return {
      headline: "Disabled",
      detail:
        provider.message ?? "This provider is installed but disabled for new sessions in Neokod.",
    };
  }
