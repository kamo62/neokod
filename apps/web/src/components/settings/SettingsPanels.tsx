  ...
  return (
    <>
      ...
      {hasDesktopBridge ? (
        <SettingsRow
          title="Update track"
          description="Stable follows full releases."
          control={<span className="text-sm text-muted-foreground">Stable</span>}
        />
      ) : null}
    </>
  );
  ...
  return (
    <SettingsPageContainer>
      <SettingsSection title="General">
        <SettingsRow
          title="Theme"
          description="Choose how Neokod looks across the app."
          resetAction={
            theme !== "system" ? (
