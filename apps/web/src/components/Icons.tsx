...
export const AsanaIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none">
    <path
      fill="currentColor"
...
/** Table/board glyph (GitHub's own Projects mark) — no distinct brand mark exists for GitHub Projects. */
export const GitHubProjectsIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 24 24" fill="none">
    <path
      fill="currentColor"
