 ...
 * present alongside the primary. WSL secondaries carry a
 * `local:<backendInstanceId>` connection id. Gating on this keeps non-WSL users
 * on the unchanged single-prompt flow.
 */
