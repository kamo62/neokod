...
import { serializeComposerFileLink } from "@neokod/shared/composerTrigger";
import { createModelSelection, normalizeModelSlug } from "@neokod/shared/model";
import {
  memo,
  useCallback,
  useEffect,
...
import type { UnifiedSettings } from "@neokod/contracts/settings";
  ...
  return (
    <>
      ...
      {props.isPreparingWorktree ? (
        <span className="text-ui text-text-secondary">Preparing worktree...</span>
      ) : null}
...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const showPlanSidebarToggle = hasPlanData || planSidebarOpen;
              ...
              <div className="px-3 pb-3 sm:px-4">
                ...
                >
                  <button
                    type="button"
                    className={cn(
                      "min-w-0 flex-1 truncate bg-transparent py-1.5 text-left text-chat",
                      activePendingProgress?.customAnswer
                        ? "text-foreground"
          ...
          {showCollapsedMobilePromptRow ? (
            <div className="flex items-center justify-between gap-2 px-3 py-2">
              <button
                type="button"
                className={cn(
                  "min-w-0 flex-1 truncate bg-transparent p-0 text-left text-chat focus:outline-none",
