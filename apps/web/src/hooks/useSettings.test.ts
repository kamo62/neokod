import { DEFAULT_SERVER_SETTINGS, ProviderDriverKind, ProviderInstanceId } from "@neokod/contracts";
import { DEFAULT_CLIENT_SETTINGS } from "@neokod/contracts/settings";
