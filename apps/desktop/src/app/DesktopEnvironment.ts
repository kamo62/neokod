...
>()("@neokod/desktop/app/DesktopEnvironment") {}

const APP_BASE_NAME = "Neokod";
...
> {
  ...
  const baseDir = yield* resolveNeokodHome({
    configuredHome: Option.getOrUndefined(config.neokodHome),
    homeDirectory,
    onWarning: (message) => process.stderr.write(`[desktop] ${message}\n`),
  });
  ...
  const userDataDirName = isDevelopment ? "neokod-dev" : "neokod";
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? "com.kamo62.neokod.dev" : "com.kamo62.neokod",
    ),
    linuxDesktopEntryName: isDevelopment ? "neokod-dev.desktop" : "neokod.desktop",
    linuxWmClass: isDevelopment ? "neokod-dev" : "neokod",
    userDataDirName,
