...
import { getStoredRuntimeMode } from "../../persistence/Layers/OrchestrationEventStore.ts";
      ...
      switch (event.type) {
        case "thread.created":
          yield* projectionThreadRepository.upsert({
            ...
            ...(getStoredRuntimeMode(event) === undefined
              ? {}
              : { storedRuntimeMode: getStoredRuntimeMode(event) }),
