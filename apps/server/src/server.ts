...
import { ProviderSessionReconcilerLive } from "./provider/Layers/ProviderSessionReconciler.ts";
...
import { ManagedClientEvidenceForwarderLive } from "./provider/copilot/ManagedClientEvidenceForwarder.ts";
...
// Neokod's primary transport is long-lived WebSocket RPC, whose Effect scope finalizer
...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  Layer.provideMerge(ManagedClientEvidenceForwarderLive()),
...
export const makeRoutesLayer = Layer.mergeAll(
  Layer.mergeAll(
    ...
    otlpTracesProxyRouteLayer,
    WslBearerAuth.wslWebSocketTicketRouteLayer,
    assetRouteLayer,
    staticAndDevRouteLayer,
