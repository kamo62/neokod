import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@neokod/contracts";
...
import { KeybindingsConfigError } from "@neokod/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "neokod-keybindings-test-",
        }),
      ),
    ),
  );
