...
import { VcsProcessExitError } from "@neokod/contracts";
  ...
  it.effect("parses merge request view output", () =>
    Effect.gen(function* () {
        ...
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              ...
              web_url: "https://gitlab.com/example-org/example-repo/-/merge_requests/42",
              target_branch: "main",
              ...
              source_project: {
                path_with_namespace: "octocat/neokod",
              },
            }),
          ),
        ),
      ...
      assert.deepStrictEqual(result, {
        number: 42,
        title: "Add MR thread creation",
        url: "https://gitlab.com/example-org/example-repo/-/merge_requests/42",
        baseRefName: "main",
            ...
            JSON.stringify([
              {
                iid: 0,
                title: "invalid",
                web_url: "https://gitlab.com/example-org/example-repo/-/merge_requests/0",
                target_branch: "main",
              ...
              },
              {
                iid: 43,
                title: "  Valid MR  ",
                web_url: " https://gitlab.com/example-org/example-repo/-/merge_requests/43 ",
                target_branch: " main ",
      ...
      assert.deepStrictEqual(result, [
        {
          number: 43,
          title: "Valid MR",
          url: "https://gitlab.com/example-org/example-repo/-/merge_requests/43",
          baseRefName: "main",
    ...
    Effect.gen(function* () {
      mockedRun.mockReturnValueOnce(
        Effect.succeed(
          processOutput(
            ...
            JSON.stringify({
              path_with_namespace: "octocat/neokod",
              web_url: "https://gitlab.com/octocat/neokod",
              http_url_to_repo: "https://gitlab.com/octocat/neokod.git",
              ssh_url_to_repo: "git@gitlab.com:octocat/neokod.git",
            }),
          ),
        ),
      );
      ...
      const result = yield* Effect.gen(function* () {
        ...
        return yield* glab.getRepositoryCloneUrls({
          cwd: "/repo",
          repository: "octocat/neokod",
        });
      });

      assert.deepStrictEqual(result, {
        nameWithOwner: "octocat/neokod",
        url: "https://gitlab.com/octocat/neokod",
        sshUrl: "git@gitlab.com:octocat/neokod.git",
      });
    }),
  );
  ...
  it.effect("creates merge requests through the GitLab API without placing the body in argv", () =>
    Effect.gen(function* () {
      ...
      yield* glab.createMergeRequest({
        ...
        title: "Provider MR",
        bodyFile: "/tmp/neokod-mr-body.md",
      });
      ...
      expect(mockedRun).toHaveBeenCalledWith(
        expect.objectContaining({
          ...
          args: [
            ...
            "title=Provider MR",
            "--field",
            "description=@/tmp/neokod-mr-body.md",
          ],
        }),
      );
    }),
