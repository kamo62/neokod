...
const resolveMockUpdateServerConfig = Effect.gen(function* () {
  ...
  const config = yield* Config.all({
    port: Config.port("NEOKOD_DESKTOP_MOCK_UPDATE_SERVER_PORT").pipe(Config.orElse(() => Config.port("T3CODE_DESKTOP_MOCK_UPDATE_SERVER_PORT")), Config.withDefault(3000)),
    root: Config.string("NEOKOD_DESKTOP_MOCK_UPDATE_SERVER_ROOT").pipe(Config.orElse(() => Config.string("T3CODE_DESKTOP_MOCK_UPDATE_SERVER_ROOT")),
