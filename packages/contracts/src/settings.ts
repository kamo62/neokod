...
export const AppIconVariant = Schema.Literals(["aurora", "prism", "signal"]);
export type AppIconVariant = typeof AppIconVariant.Type;
export const DEFAULT_APP_ICON_VARIANT: AppIconVariant = "prism";
...
export const ClientSettingsSchema = Schema.Struct({
  appIconVariant: AppIconVariant.pipe(
    Schema.withDecodingDefault(Effect.succeed(DEFAULT_APP_ICON_VARIANT)),
  ),
  ...
  webActivityNotificationsEnabled: Schema.Boolean.pipe(
...
export const CodexSettings = makeProviderSettingsSchema(
  {
    ...
    shadowHomePath: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        providerSettingsForm: {
          placeholder: "~/.codex-neokod/personal",
          clearWhenEmpty: "omit",
        },
      }),
    ),
...
export const GrokSettings = makeProviderSettingsSchema(
  {
    // Disabled by default: Claude and GitHub Copilot ship as the
    // out-of-the-box agents in this fork; Grok stays in code but opt-in.
    enabled: Schema.Boolean.pipe(
      Schema.withDecodingDefault(Effect.succeed(false)),
      Schema.annotateKey({ providerSettingsForm: { hidden: true } }),
    ),
...
export const CopilotSettings = makeProviderSettingsSchema(
  ...
  {
    order: ["binaryPath", "baseDirectory"],
  },
);
...
export const OpenCodeSettings = makeProviderSettingsSchema(
  {
    // Disabled by default: Claude and GitHub Copilot ship as the
    // out-of-the-box agents in this fork; OpenCode stays in code but opt-in.
    enabled: Schema.Boolean.pipe(
      Schema.withDecodingDefault(Effect.succeed(false)),
      Schema.annotateKey({ providerSettingsForm: { hidden: true } }),
    ),
    ...
    serverUrl: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Server URL",
        description: "Leave blank to let Neokod spawn the server when needed.",
        providerSettingsForm: {
...
export const ClientSettingsPatch = Schema.Struct({
  ...
  webActivityNotificationsEnabled: Schema.optionalKey(Schema.Boolean),
