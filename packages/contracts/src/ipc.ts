...
export const DesktopUpdateChannelSchema = Schema.Literals(["latest"]);
...
export interface DesktopPreviewWebviewConfig {
  /** `persist:neokod-preview` (or whatever the desktop chose). */
  partition: string;
  /**
...
export interface EnvironmentApi {
  ...
  review: {
    ...
    getChangedFiles: (input: ReviewChangedFilesInput) => Promise<ReviewChangedFilesResult>;
    getFileDiff: (input: ReviewFileDiffInput) => Promise<ReviewFileDiffResult>;
  };
  orchestration: {
