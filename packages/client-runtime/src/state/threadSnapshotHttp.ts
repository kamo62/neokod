import type { OrchestrationThreadDetailSnapshot, ThreadId } from "@neokod/contracts";
 ...
 * Decouples the thread state machine from the underlying HTTP authorization details and
...
>()("@neokod/client-runtime/state/threadSnapshotHttp/ThreadSnapshotLoader") {}
